                                        ...
                                        <div class="col-md-3 col-sm-12 d-flex justify-content-end">
                                            <div class="btn-toolbar mb-3" role="toolbar" aria-label="Export">
                                                <div class="btn-group me-2" role="group" aria-label="Export group">
                                                    ...
                                                    <a href="#bills-export-xlsx" class="btn btn-outline-success show-label-on-hover">
                                                        ...
                                                        <span class="hover-label">Excel</span>
                                                    </a>

                                                    <a href="#bills-export-csv" class="btn btn-outline-secondary show-label-on-hover">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                        ...
                                                        <span class="hover-label">CSV</span>
                                                    </a>

                                                    <a href="#bills-export-pdf" class="btn btn-outline-danger show-label-on-hover">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                        ...
                                                        <span class="hover-label">PDF</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
